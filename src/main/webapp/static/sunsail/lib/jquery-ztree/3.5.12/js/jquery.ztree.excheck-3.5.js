...
(function($){
	...
	_view = {
		...
		setChkClass: function(setting, obj, node) {
			...
			// modify by wzf 20140623 start
			var className = obj.attr("class");
			var index = className.indexOf(" ", className.indexOf(" ") + 1); // 第二个空格的位置
			var toRemoveClass = className.substring(index);
			obj.removeClass(toRemoveClass);
			//obj.removeClass();
			// modify by wzf 20140623 end
