$(document).ready(function(){
    $("#costManagementEdit2").jqGrid({
       ...
       // autowidth:true,//自动宽
        ...
        colNames:['费用类型', '费用单价', '数量', '金额', '司机代收', '应收操作人', '应收备注', '实收金额', '实收凭证1(月结号？)', '实收凭证2', '实收凭证3', '实收操作人', '实收备注'],
        colModel:[
	...
	var mydata = [
			{costType:"码头费",unitPrice:"68",count:"1",amounts:"68",collectionOfDrivers:"否",accountsReceivable:"小汤",notesReceivable:"",realIncomeAmount:"",realEvidence1:"如：榜单号",realEvidence2:"如：榜单号",realEvidence3:"如：榜单号",realOperator:"",realCharge:""},
			{costType:"超期费用",unitPrice:"30",count:"1",amounts:"30",collectionOfDrivers:"否",accountsReceivable:"小汤",notesReceivable:"注：按当前日期/船期/码头自动计算，集装箱单位",realIncomeAmount:"",realEvidence1:"",realEvidence2:"",realEvidence3:"",realOperator:"",realCharge:""},
			{costType:"滞期费",unitPrice:"70",count:"1",amounts:"70",collectionOfDrivers:"否",accountsReceivable:"小汤",notesReceivable:"注：按当前日期/船期/船东，集装箱单位",realIncomeAmount:"",realEvidence1:"",realEvidence2:"",realEvidence3:"",realOperator:"",realCharge:""}
			];
