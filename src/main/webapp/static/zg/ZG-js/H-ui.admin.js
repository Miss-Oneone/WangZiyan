...
$(function(){
	...
	$(".Hui-aside .menu_dropdown a").click(function(){
		...
		var _parentName=$(this).attr('title');
		var _titleName= _parentName + "-" + $.trim($(this).html());
		...
		if(!bStop){
			...
			var iframe_member=iframe_box.find(".show_iframe").hide().eq(bStopIndex).show();	
			iframe_member.find("iframe").attr("src", _href);
		}
	});
	min_titleList()
