...
jQuery.validator.addMethod("amount", function(b, a) {
	return this.optional(a) || /^[0-9]{1,9}[\.0-9]{0,3}$/.test(b)
}, "格式不对");

jQuery.validator.addMethod("weight", function(b, a) {
	return this.optional(a) || /^[0-9]{1,11}[\.0-9]{0}$/.test(b)
}, "格式不对");