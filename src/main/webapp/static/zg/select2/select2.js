    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var $dropdown = this.dropdown,
                ...
                //标签的宽度及显示的宽度
                var tempWidth = parseInt(this.container.find("a").css("width")) + parseInt(this.container.find("a").css("padding-left"));
                //判断是否是ie浏览器，如果是则不添加padding宽度
                if(!$.browser.msie) {
                	tempWidth = tempWidth + 2 * parseInt(this.container.find("a").css("border-left-width"));
                }
                if(tempWidth > 0) {
                	width = tempWidth;
                }
