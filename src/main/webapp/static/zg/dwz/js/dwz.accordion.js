...
// 修改导航栏隐藏时高度不正确的问题。因为取不到accordionHeader高度  $(".accordionHeader:first-child", obj).outerHeight()=0
//	var height = parent.height() - (($(".accordionHeader", obj).size()) * ($(".accordionHeader:first-child", obj).outerHeight())) -2;
	var accordionHeaderHeight = 25;
	var height = parent.height() - (($(".accordionHeader", obj).size()) * accordionHeaderHeight) -2;
