...
<head>
    ...
    <%@ include file="/WEB-INF/views/modules/mst/gps/gpsDailyKmJs.jsp"%>
    <style type="text/css">
        .a-info {
    ...
    <div class="content-head">
        <form id="searchForm"  method="post" action="">
            <div class="row cl">
                ...
                <div class="col-3">
                    <tags:date id="dateFrom" name="dateFrom" width="100" value="${dateFrom}"></tags:date>-
                    <tags:date id="dateTo" name="dateTo" width="100" value="${dateTo}"></tags:date>
                </div>
                <div class="col-1">
                    <tags:label key="车牌号"/>
                </div>
